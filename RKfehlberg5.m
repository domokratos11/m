...
% Ejemplo de clase y'= tsen(2t)+ ytan(t)
% - Introduzca la ecuación diferencial        : 'Dy=x*sin(2*x)+y*tan(x)'
% - Introduzca la condición y(a)=b            : 'y(pi)=(pi/3)'
% - Introduzca la función de trabajo          : x*sin(2*x)+y*tan(x)
% - Introduzca la condición inicial           : (pi/3)
% - Introduzca el valor de a                  : pi
% - Introduzca el valor de b                  : ((121/120)*pi)
% - Introduzca el tamaño de paso h            : (pi/600)
...
for j=a:h:(b-h)
   ...
   fprintf('\n');
   fprintf('- K1 = %1.5f * f(%1.5f,w%1.0f)',h,t(i),i-1);
   fprintf('\n');
   ...
   fprintf('\n');
   fprintf('- K2 = %1.5f * f(%1.5f + %1.10f , w%1.0f + %1.15f)',h,t(i),h/4,i-1,double(k1)/4);
   fprintf('\n');
   ...
   fprintf('\n');
   fprintf('- K3 = %1.5f * f(%1.5f + %1.10f , w%1.0f + %1.15f + %1.15f)',h,t(i),((3/8)*h),i-1,(3*(double(k1))/32),(9*(double(k2))/32));
   fprintf('\n');
   ...
   fprintf('\n');
   fprintf('- K4 = %1.5f * f(%1.5f + %1.10f , w%1.0f + %1.15f - %1.15f + %1.15f)',h,t(i),((12/13)*h),i-1,(1932*(double(k1))/2197),(7200*(double(k2))/2197),(7296*(double(k3))/2197));
   fprintf('\n');
   ...
   fprintf('\n');
   fprintf('- K5 = %1.5f * f(%1.5f + %1.5f , w%1.0f + %1.15f - %1.15f + %1.15f - %1.15f)',h,t(i),h,i-1,(439*(double(k1))/216),(8*(double(k2))),(3680*(double(k3))/513),(845*(double(k3))/4104));
   fprintf('\n');
   ...
   fprintf('\n');
   fprintf('- K6 = %1.5f * f(%1.5f + %1.5f , w%1.0f + %1.15f + %1.15f - %1.15f + %1.15f - %1.15f)',h,t(i),h,i-1,(8*(double(k1))/27),(2*(double(k2))),(3544*(double(k3))/2565),(1859*(double(k3))/4104),(11*(double(k3))/40));
   fprintf('\n');
...
for k1=0:k3
   k2=k1+1;
   fprintf('              %1.0f  |  %10.5f  |  %10.15f  |  %10.15f',k(k2),q(k2),w(k2),v(k2));
   fprintf('\n');                                      
end
